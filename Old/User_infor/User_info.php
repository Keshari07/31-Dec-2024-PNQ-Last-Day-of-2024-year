...
<br>
          <div class="form-group">
             <label  style="background-color: #f0f0f0">User ID</label>
                 <input type="text" class="form-control" name="id" placeholder="Enter Your U ID" required/>
                 </div>     
       ...
       <div class="form-group">
        <label  style="background-color: #f0f0f0">Password</label>
         <input type="text" name="password" class="form-control" placeholder="Enter Your Password" required/>
           </div>

         <div class="form-group">
           <label  style="background-color: #f0f0f0">Confirm Password</label>
              <input type="text" name="cpassword" class="form-control" placeholder="Enter Your Confirm Password" required/>
              </div>
