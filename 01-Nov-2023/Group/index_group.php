...
<body>
    <div class="container">
        <div class="panel panel-primary">
            ...
            <form action="data_group.php" method="POST">
                <br>
             ...
             <div class="form-group">
                  <label style="background-color: #f0f0f0">Group  Type </label>
                  <input type="text" class="form-control" name="group_type" placeholder="Enter Your User Type"required />
                </div>
